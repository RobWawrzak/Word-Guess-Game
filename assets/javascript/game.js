...
var wrongLetters = []; //array to hold letters that are guessed && not in the word
var correctLetters = []; // array to hold letters guessed && in the word
